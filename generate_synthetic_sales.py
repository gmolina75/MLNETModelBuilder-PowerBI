...
# Reglas:
# 3000 registros, 1 enero 2025 a 31 diciembre 2025
...
for cat in categories:
    ...
    for i in range(num_prods):
        # Vary the price slightly around the base price
        price = round(cat["base_price"] * random.uniform(0.5, 1.5), 2)
        # Assign a relative popularity to the product
...
filename = "ventas_sinteticas_2025.csv"
fieldnames = [
